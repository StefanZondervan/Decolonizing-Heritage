document.addEventListener('DOMContentLoaded', function () {
    ...
    // Get a reference to your main map SVG
    ...
    // Add fade-element class to all controlled elements
    ...
    function getSvgCoordinates(clientX, clientY) {
        ...
        svgPoint.y = clientY;
        try {
            const CTM = mainMapSVG.getScreenCTM();
            if (CTM) {
    ...
    function updateConnectionLine(dotElement, containerElement) {
        ...
        if (!connectionLine) {
            ...
            connectionLine.removeAttribute('stroke-dasharray');
            connectionLine.style.pointerEvents = 'none';
            connectionLine.style.opacity = '0';
            connectionLine.style.transition = 'opacity 0.3s ease-in-out';
    ...
    // Close carousel if clicked outside
